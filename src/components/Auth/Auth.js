    ...
    return (
        <form className="auth" method="POST" onSubmit={onSubmit} noValidate>
          ...
          {errors && errors["email"] && errors["email"]}
                ...
                <input className={`auth__input ${errors && errors["password"] && 'auth__input_type_error'}`}
        ...
        {errors && errors["password"] && errors["password"]}
            ...
            <button className="auth__submit-button" type="submit" disabled={!isValid}>{buttonText} </button>
